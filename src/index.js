        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < newPresences.length; i++) {
                ...
                if (newUser.userId == oldUser.userId && (newUser.status != oldUser.status || ((_a = newUser.activities[0]) === null || _a === void 0 ? void 0 : _a.name) != ((_b = oldUser.activities[0]) === null || _b === void 0 ? void 0 : _b.name))) {
                    ...
                    var sql = `INSERT INTO status (USER_ID, DATE, USERNAME, STATUS, ACTIVITIES) VALUES ('${parseInt(newUser.userId)}', current_timestamp(), '${bot.users.cache.find((u) => u.id === newUser.userId).tag}', '${newUser.status}', '${(_h = (_g = newUser.activities[0]) === null || _g === void 0 ? void 0 : _g.name) !== null && _h !== void 0 ? _h : null}')`;
